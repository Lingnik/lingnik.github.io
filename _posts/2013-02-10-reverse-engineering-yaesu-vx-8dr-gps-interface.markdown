...
redirect_from: [/content/reverse-engineering-yaesu-vx-8dr-gps-interface/index.html]
---
...
There's no easy way to find out what version of NMEA the VX-8DR (or VX-8GR) support. (Until Yaesu support gets back to me.)
   ...
   [4]: {{ site.url }}/assets/yaesu/garmin-gpsmap-60csx-serial-interface.png
   [5]: https://www.adafruit.com/products/824
   [6]: {{ site.url }}/assets/yaesu/Garmin_Interface_500px.jpg
   [7]: http://www.moxa.com/product/download_pcommlite_info.htm
   [8]: http://www.universal-radio.com/catalog/ht/0008.html
   [9]: {{ site.url }}/assets/yaesu/yaesu-ct-m11-cable-pin-numbers.png
   [10]: {{ site.url }}/assets/yaesu/yaesu-vx-8dr-mic-pinout.png
   [11]: {{ site.url }}/assets/yaesu/yaesu-ct-m11-cable-pinout.png
   [12]: http://www.g4hfq.co.uk/links.html
   [13]: {{ site.url }}/assets/yaesu/Yaesu_Cable_500px.jpg
   [14]: {{ site.url }}/assets/yaesu/Yaesu_Bad_500px.jpg
   ...
   [22]: {{ site.url }}/assets/yaesu/Yaesu_Good_500px.jpg
